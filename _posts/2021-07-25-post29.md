...
![note that 'WeakSelf' was the name of the app that crashed](../images/2021-07-25-post29/1.png)

이제 `[weak self]`의 이점을 확인했으므로, 모든 클로저에서 이를 사용하기 시작해야 할까요?

저는 잠시동안 다음 사진과 같은 상태였습니다:

![Image 2](../images/2021-07-25-post29/2.jpeg)
...
![Image 3](../images/2021-07-25-post29/3.png)
...
![The staircase is not a good sign!](../images/2021-07-25-post29/4.png)
